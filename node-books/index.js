...
const createBook = (id, author, title, year) => ({
    id, author, title, year
})

const createAuthor = (id, firstName, lastName, bio) => ({
...
const authors = [
    createAuthor(1, "Kate", "Chopin", "Kate Chopin (1850–1904) was an American author known for her pioneering short stories and novels, particularly The Awakening (1899)."),
    createAuthor(2, "J.K.", "Rowling", "Joanne Rowling was born on July 31, 1965, in Yate, near Bristol, England. She grew up in England and in Chepstow, Gwent, Wales. She loved reading and wrote her first story at the age of six."),
    createAuthor(3, "Maccio", "Capatonda", "Marcello Macchia (born 2 August 1978) is an Italian comedian, actor, writer and filmmaker. He is best known by his stage name Maccio Capatonda")
]
